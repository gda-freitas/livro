...
<div class="pos-f-t">
      <div class="collapse" id="navbarToggleExternalContent">
        <div class="bg-dark p-4">
			<a class="nav-link navbar-brand text-white" href='..\livro\listar.php'>Listar Livros</a>
			<?php if($_SESSION['administrador']=='A'){?>
			<a class="nav-link navbar-brand text-white" href='..\livro\incluir.php'>Incluir novo Livro</a>
